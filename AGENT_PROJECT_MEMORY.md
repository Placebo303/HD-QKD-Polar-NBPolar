...
- Next gates [decision]: G3 consumed with stop (`SCLW_STOP_SANITY_HIGH` — no disclosure bite for greedy at the frozen d=0.90 point; SCL stays locked); Tier-X queue cap 6 with Q1/Q2 done and Q3/Q4 next — reaching the cap FORCES the exhaustion-route return; the exhaustion-route decision (redesign / acquisition / closeout) remains user-owned PENDING.
