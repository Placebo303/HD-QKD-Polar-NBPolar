...
- Next gates [decision]: G3 synthetic working-point execution (needs its own freeze + explicit authorization; SCL stays locked until then) + the exhaustion-route decision for the real-data ladder (redesign / acquisition / closeout), forced when the Tier-X queue reaches its cap of 6.
