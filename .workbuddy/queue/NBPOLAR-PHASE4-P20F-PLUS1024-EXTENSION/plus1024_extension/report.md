...
- protocol: `nbpolar-p20f-plus1024-extension` (mode `dev-plus1024-extension`)
- source: `1M`; n=32768, k1=319, k2=6492, B1 K2=7516 (+1024 L2 order-prefix step)
- DEV blocks: [[768, 895], [896, 1023], [1024, 1151]]; remainder [1152, 1199] (never used)
- closed HOLD: [1600, 1983] (never selected); consumed VAL: [1200, 1599] (never selected); consumed P20C DEV: [0, 383] (never selected); consumed P20E DEV: [384, 767] (never selected)
- base cap: 34119 key bits/block; B1 cap: 39239 key bits/block (raw 327680 bits; ratios 0.104123 / 0.119748)
- wall: 92.957429 s; peak RSS: 579555328 bytes; resource stop fired: False
...
- gates all pass: True
- failing: []
- label: `TARGET_EMPIRICAL_N32768_DEV_PLUS1024_EXTENSION_COMPLETE`
