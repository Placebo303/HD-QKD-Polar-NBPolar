...
| `20260120_Type0_nofilter_500K_3s` | 2026-01-20 | `Type0_nofilter` ⚠️ | `500K` | 3s | 21,072 + 13,240,624 | 13,261,696 (~12.6 MiB) | YES — names only (`e2e_new_ttbin_fullgrid_20260305_031909/`) | LIKELY_NEW_SESSION + TYPE0 flag |
| `20260120_Type0_nofilter_1M_3s` | 2026-01-20 | `Type0_nofilter` ⚠️ | `1M` | 3s | 21,072 + 23,285,488 | 23,306,560 (~22.2 MiB) | YES — names only (`e2e_new_ttbin_fullgrid_20260304_231635/`) | LIKELY_NEW_SESSION + TYPE0 flag |
| `20260120_Type0_nofilter_1_5M_3s` | 2026-01-20 | `Type0_nofilter` ⚠️ | `1_5M` | 3s | 21,072 + 33,469,312 | 33,490,384 (~31.9 MiB) | YES — names only (`e2e_new_ttbin_fullgrid_20260305_055352/`) | LIKELY_NEW_SESSION + TYPE0 flag |
| `20260120_Type0_nofilter_2M_3s` | 2026-01-20 | `Type0_nofilter` ⚠️ | `2M` | 3s | 21,072 + 47,920,192 | 47,941,264 (~45.7 MiB) | YES — names only (`e2e_new_ttbin_fullgrid_20260305_011024/`) | LIKELY_NEW_SESSION + TYPE0 flag |
...
`TYPE0_SOURCE_UNVERIFIED_NEEDS_PI_CONFIRMATION`. What the names say: the four 2026-01-20
directories are labeled `Type0_nofilter_…`, which is a different source label from the `Type2*`
labels of the other six acquisitions and from the Type-II SPDC identity of the frozen sessions.
Do NOT assume these four are usable for the frozen ToA pipeline — needs explicit PI confirmation.
...
- Whether `Type0_nofilter` data is pipeline-usable (`TYPE0_SOURCE_UNVERIFIED_NEEDS_PI_CONFIRMATION`).
